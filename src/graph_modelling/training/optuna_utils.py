...
def define_model_param_space(trial, model_name: str) -> Dict[str, Any]:
    ...
    elif "stgcn" in model_name.lower() or "astgcn" in model_name.lower():
        params.update({
            "hidden_channels": trial.suggest_int("hidden_channels", 32, 128, step=16),
            "temporal_kernel_size": trial.suggest_int("temporal_kernel_size", 3, 7, step=2),
            "spatial_kernel_size": trial.suggest_int("spatial_kernel_size", 2, 4),
            "dropout": trial.suggest_float("dropout", 0.1, 0.5),
        })
...
def create_objective(
    ...
    Args:
        model_fn: Function to create model with parameters
    ...
    Returns:
        The objective function to be used by Optuna
    """
        ...
        try:
            ...
            for epoch in range(1, n_epochs + 1):
                ...
                for x_batch, y_batch in train_loader:
                    ...
                    y_hat = model(x_batch, edge_index.to(device), edge_weight.to(device))
